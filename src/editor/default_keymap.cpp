...
constexpr std::array kEditorBindings{
    ...
    Binding{"C-x 2", "window.split-below"},
    Binding{"C-x 3", "window.split-right"},
    Binding{"C-x 0", "window.delete"},
    Binding{"C-x 1", "window.delete-others"},
    Binding{"C-x o", "window.other"},
    ...
    Binding{"M-g n", "location.next-error"},
    Binding{"M-g p", "location.previous-error"},
    Binding{"C-x `", "location.next-error"},
